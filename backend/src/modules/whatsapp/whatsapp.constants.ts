...
\u2022 status`,
  ...
  VOICE_NOT_SUPPORTED: 'Voice-note processing is not enabled yet. Please send a text message for now.',

  UNSUPPORTED_TYPE: 'This message type is not supported yet. Please send a text message.',

  FINANCIAL_NOT_READY: 'Your message was received successfully.\n\nFinancial message understanding will be enabled in the next stage.',

  UNAUTHORIZED: 'This WhatsApp number is not connected as an authorized Salligo user.',
